...
void GnuPlot::AddPoints(std::vector<Punkt<double> > points ,std::string point_type, std::string rgb_color,  std::string title)
{
    main_cmd += "'-' u 1:2 title \"" + title + "\" w p ls " + point_type + " lt rgb \"0x00" + rgb_color + "\",";
...
void GnuPlot::AddLines(std::vector<Punkt<double> > points ,std::string point_type, std::string rgb_color,  std::string title)
{
    main_cmd += "'-' u 1:2 title \"" + title + "\" w linespoints ls " + point_type + " ps 0.01 lt rgb \"0x00" + rgb_color + "\",";
...
void GnuPlot::SetSize(Punkt<double> przedzial)
{
    double h = fabs(przedzial.x) + fabs(przedzial.y);
    SetSize(przedzial.x,przedzial.y, -h, h);
}

void GnuPlot::SetSize(Punkt<double> przedzial_x, Punkt<double> przedzial_y)
{
    SetSize(przedzial_x.x, przedzial_x.y, przedzial_y.x, przedzial_y.y);
}
